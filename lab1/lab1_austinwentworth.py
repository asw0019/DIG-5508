...
def compare(input1, input2):
    if input1 < input2:
        print(str(input1) + " is totally less than " + str(input2) + ", dudes!")
    elif input1 > input2:
        print(str(input1) + " is totally greater than " + str(input2) + ", dudes!")
    else:
        print(str(input1) + " is totally equal to " + str(input2) + ", dudes!")
